...
### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Jijinr/Ash921156)
...
Deploy in your vps
```sh
git clone https://github.com/Jijinr/Ash921156
cd Frwit
